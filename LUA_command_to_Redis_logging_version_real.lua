...
-- (See the file "LUA_command_to_Redis_logging_version_formatted.lua"
-- for a version of the script below in pretty-print format. Custom
-- LUA functions are in upper-case to help to distinguish them in
-- that line.)
--
